...
Body 
    ...
    - ssh -i "DevBond-secret.pem" ubuntu@ec2-43-204-96-49.ap-south-1.compute.amazonaws.com
    ...
    - Backend
        ...
        - npm intsall pm2 -g
        - pm2 start npm --name "DevBond-backend" -- start
        - pm2 logs
...
# Ngxinx config: 
        ...
        Domain name = DevBond.com => 43.204.96.49

        Frontend = DevBond.com
        Backend = DevBond.com:7777 => DevBond.com/api
...
# Addding a custom Domain name
    ...
    - DNS record: A DevBond.in 43.204.96.49
